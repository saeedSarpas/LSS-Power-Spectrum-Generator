/**
 * find_first_mode_with_modulus_test.c
 * @test_for find_first_mode_with_modulus.c
 *
 * @author Saeed Sarpas
 */
...
#include "./find_first_mode_with_modulus.h"
#include "./sort_modes.h"

Describe(find_first_mode_with_modulus);
...
BeforeEach(find_first_mode_with_modulus) {}

AfterEach(find_first_mode_with_modulus) {}

Ensure(find_first_mode_with_modulus, returns_right_results_in_a_random_array) {

    fill_array_with_random_numbers();

    int i, index, start_point = 0;
    ...
    index = find_first_mode_with_modulus(value, modes_array, ARRAY_LENGTH);
...
Ensure(find_first_mode_with_modulus,
...
TestSuite *find_first_mode_with_modulus_tests() {
    ...
    add_test_with_context(suite, find_first_mode_with_modulus,
